...
(cl:in-package rescue_pkg_noetic-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rescue_pkg_noetic-msg:<Num> is deprecated: use rescue_pkg_noetic-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rescue_pkg_noetic-msg:num-val is deprecated.  Use rescue_pkg_noetic-msg:num instead.")
  (num m))
